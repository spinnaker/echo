...
public class PipelineTriggerConfiguration {
  ...
  PubsubEventHandler pubsubEventHandler(Registry registry, ObjectMapper objectMapper, BuildArtifactExtractor buildArtifactExtractor) {
    return new PubsubEventHandler(registry, objectMapper, buildArtifactExtractor);
  }
