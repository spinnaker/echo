...
class GithubConfig {
  ...
  @Bean
  Endpoint githubEndpoint(@Value('${github.endpoint}') String endpoint) {
    newFixedEndpoint(endpoint)
  }

  @Bean
  GithubService githubService(Endpoint githubEndpoint,
                              Client retrofitClient,
                              RestAdapter.LogLevel retrofitLogLevel) {

    log.info("Github service loaded")

    def githubClient = new RestAdapter.Builder()
