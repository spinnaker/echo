...
class SlackNotificationServiceSpec extends Specification {
  ...
  def slackHookService = Mock(SlackConfig.SlackHookService)
  ...
  def "handling a notification causes a Slack message to be sent to each channel in the to field"() {
    ...
    slack.configProperties >> new SlackConfig.SlackProperties()
  ...
  def "parsing an interaction callback from Slack returns the matching generic representation"() {
    ...
    InteractiveActionCallback expectedCallbackObject = new InteractiveActionCallback(
