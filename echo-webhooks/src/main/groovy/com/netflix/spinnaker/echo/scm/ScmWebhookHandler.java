...
public class ScmWebhookHandler {
  private List<GitWebhookHandler> webhookEventHandlers = new ArrayList<>();

  @Autowired
  public ScmWebhookHandler(List<GitWebhookHandler> webhookEventHandlers) {
  ...
  public GitWebhookHandler getHandler(String source) {
    return webhookEventHandlers.stream()
        ...
        .findFirst()
        .orElseThrow(() -> new IllegalArgumentException("Unknown Git SCM source " + source));
  }
}
